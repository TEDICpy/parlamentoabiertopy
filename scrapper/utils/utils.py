...
def download_bill_resolutions_and_messages(row_index, button_index, project_id, viewstate, session_id):
     if button_index == None:
          button_index = 0
     data = "formMain=formMain&formMain%3Aj_idt124%3Aj_idt220%3A" + row_index + \
            "%3Aj_idt233%3A" + button_index + \
            "%3Aj_idt234=&formMain%3Aj_idt124_activeIndex=4&javax.faces.ViewState=" +\
            viewstate
     dirname = 'download/bills/resolutions_and_messages/%s' %(project_id)
